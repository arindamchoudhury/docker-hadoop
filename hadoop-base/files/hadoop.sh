...
export HADOOP_PID_DIR HADOOP_LOG_DIR YARN_LOG_DIR HADOOP_PREFIX HADOOP_COMMON_HOME HADOOP_HDFS_HOME HADOOP_MAPRED_HOME HADOOP_YARN_HOME HADOOP_CONF_DIR YARN_CONF_DIR PATH
